...
parser.add_argument(
    ...
    nargs="?",
    default=
    "serafuku, direct looking, eyeball, hair flower, close-up, gentle eyes, Hanfu pure wind, beauty, atmosphere light, shadow, detail, high quality, master works",
...
generator = StableDiffusion(img_height=args.H,
                            img_width=args.W,
                            jit_compile=False,
