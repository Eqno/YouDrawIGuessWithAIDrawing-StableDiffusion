...
class StatusCode(IntEnum):
    ...
    ERR_GAME_PLAYER_NUM_EXCEED_MAX = 300
    ERR_GAME_PLAYER_JOIN_GAME_FAILED = 301
    ERR_GAME_PLAYER_GET_OTHER_IN_ROOM_FAILED = 302
    ERR_GAME_PLAYER_SET_READY_FAILED = 303

    ERR_GAME_GET_STATE_FAILED = 304
    ERR_GAME_DID_NOT_COMMIT_ANITHING = 305
    ERR_GAME_COMMIT_INFO_FAILED = 306
    ERR_GAME_GET_INFO_FAILED = 307

    ERR_MODEL_UNKNOWN_ERROR = 500
...
error_msg = {
    ...
    StatusCode.ERR_GAME_DID_NOT_COMMIT_ANITHING: '未提交任何信息',
    StatusCode.ERR_GAME_COMMIT_INFO_FAILED: '提交信息失败',
    StatusCode.ERR_GAME_GET_INFO_FAILED: '获取信息失败'
}
